    ...
    render() {
        return (
            <View >
                ...
                <Image style={{width:300,height:300,}}source={require('../../images/getstarted1.png')}/>
                </View>
                <View style={{alignItems:'center'}}>
                ...
                <TouchableOpacity style={[styles.SubmitButtonStyle,{backgroundColor:'#FF4E56'}]} activeOpacity = { .5 } onPress={ this.ButtonClickCheckFunction }>
